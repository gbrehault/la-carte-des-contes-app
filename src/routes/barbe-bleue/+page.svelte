...
<section bind:this={section} class="relative h-[100vh] bg-cover bg-center">
  ...
  >
    <h1 class="text-5xl font-bold text-barbe-light font-title">Barbe Bleue</h1>
...
<section class="flex flex-col items-center justify-center pt-30">
  ...
  <div class="flex items-center jsutfify-center my-20 px-4">
    <h3 class="font-sb text-3xl max-w-4xl text-center">
      On dit que Barbe Bleue gardait ses secrets derrière une porte close. Mais
      parfois, les secrets les plus sombres ne vivent pas dans un château… ils
      se cachent dans une maison ordinaire, derrière un sourire, un ton doux,
      une promesse. La curiosité n’est pas un défaut quand elle sert à se
      protéger. Quand quelque chose te semble étrange, écoute ton instinct.
      N’aie pas peur d’ouvrir la porte du silence. Un adulte de confiance saura
      t’écouter et t’aider à sortir des pièces où la peur veut te retenir.
    </h3>
  </div>
  <div
  ...
  >
    ...
    >
      <path
        ...
        class="fill-barbe-light stroke-barbe-light transition-all duration-300 group-hover:fill-barbe-dark group-hover:stroke-barbe-dark"
      />
    </svg>
    <a
      href="/"
      class="font-title font-bold text-3xl pt-2 text-barbe-light transition-colors duration-300 group-hover:text-barbe-dark"
    ...
    >
      <path
        ...
        class="fill-barbe-light transition-all duration-300 group-hover:fill-barbe-dark"
      />
      <path
  ...
  <h2 class="font-bold text-barbe-light font-title text-5xl text-center mt-30">
