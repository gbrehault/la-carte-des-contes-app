...
<section bind:this={section} class="relative h-[100vh] bg-cover bg-center">
  ...
  >
    <h1 class="text-5xl font-bold text-peter-light font-title">Peter Pan</h1>
...
<section class="flex flex-col items-center justify-center pt-30">
  ...
  <div class="flex items-center jsutfify-center my-20 px-4">
    <h3 class="font-sb text-3xl max-w-4xl text-center">
      Peter volait entre les étoiles, libre comme le vent. Mais toutes les
      ombres ne suivent pas les enfants jusqu’à Neverland. Certaines
      s’approchent doucement, elles sourient, elles flattent, elles disent
      vouloir jouer… mais elles mentent. Wendy, elle, a compris que la vraie
      magie, c’est de dire quand quelque chose ne va pas. Car parler, c’est
      retrouver son chemin vers la lumière. Et il y aura toujours un adulte de
      confiance pour rallumer les étoiles quand une ombre veut les éteindre.
    </h3>
  </div>
  <div
  ...
  >
    ...
    >
      <path
        ...
        class="fill-peter-light stroke-peter-light transition-all duration-300 group-hover:fill-peter-dark group-hover:stroke-peter-dark"
      />
    </svg>
    <a
      href="/"
    ...
    >
      <path
        ...
        class="fill-peter-light transition-all duration-300 group-hover:fill-peter-dark"
      />
      <path
  ...
  <h2 class="font-bold text-peter-light font-title text-5xl text-center mt-30">
